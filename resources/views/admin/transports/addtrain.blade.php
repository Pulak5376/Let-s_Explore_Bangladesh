    ...
    <div class="add-transport-wrapper">
        <div class="form-container">
            <div class="form-header">
                ...
                <p>Enter train details to add to the transport system</p>
            </div>

            <div id="msg-box"></div>

            <form id="addTrainForm" action="{{ route('admin.transports.storetrain') }}" method="POST" class="transport-form">
                @csrf

                <div class="form-row">
                    <div class="form-group">
                        <label for="name"><i class="fas fa-train"></i> Operator Name</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="price" step="1" name="price" value="{{ old('price') }}"
                            min="0" required>
                        @error('price')
                            <small class="input-error">{{ $message }}</small>
                        @enderror
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> Adding Train...';
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    showMsg(result.message || 'Failed to add train. Please check your input.',
                        'error');
                }
            } catch (error) {
