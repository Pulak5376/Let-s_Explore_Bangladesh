            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-gradient-warning text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Gallery</h4>
                    ...
                    <form action="{{ route('admin.galleries.update', $gallery->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="location" name="location" value="{{ old('location', $gallery->location) }}" required>
                            </div>
                        </div>
                        ...
                        @if($gallery->image_url)
                            <div class="mb-3">
                                ...
                                <div class="current-image-container">
                                    <img src="{{ asset($gallery->image_url) }}" alt="{{ $gallery->title }}" class="img-thumbnail current-image">
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="mb-4">
                            <label for="image" class="form-label">
                                ...
                                @if($gallery->image_url)
                                    Change Image
                                @else
                                    Gallery Image <span class="text-danger">*</span>
                                @endif
                            </label>
                            <input type="file" class="form-control" id="image" name="image" accept="image/*" {{ !$gallery->image_url ? 'required' : '' }}>
